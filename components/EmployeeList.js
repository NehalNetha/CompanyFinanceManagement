...
const getPayrolls = async () => {
  try {
    const res = await fetch('http://localhost:3000/api/createInvoice', {
      cache: 'no-store',
    });
    if (!res.ok) {
        ...
        <div>
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableRow>
                    ...
                    <StyledTableCell align="right">Social Security&nbsp;(g)</StyledTableCell>
                ...
                {employees.map((pr) => (
                    ...
                    <StyledTableCell align="right">{pr.socialSecurity}</StyledTableCell>
                    <StyledTableCell align="right">{pr.numberOfWithholdings}</StyledTableCell>
